describe("Registro y autenticación de usuarios", () => {
  ...
  it("Crear usuario", () => {
    ...
    cy.get('.Toastify__toast-body > :nth-child(2)').should("have.text", "Usuario creado correctamente");
  })
  ...
  it("Actualizar información", () => {
    ...
    cy.get('.Toastify__toast-body > :nth-child(2)').should("have.text", "Información actualizada!");
  })
});
